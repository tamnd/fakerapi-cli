...
Most of these come down to network reality or how fakerapi serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

fakerapi rate-limits like any public site. fakerapi already paces
...
Where a surface is gated, fakerapi reads a cookie or token you supply
...
`fakerapi`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what fakerapi actually did
