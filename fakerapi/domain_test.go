...
// HTTP behaviour is covered in fakerapi_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "fakerapi://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("fakerapi", "about")
	if err != nil || got.String() != "fakerapi://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want fakerapi://page/about", got.String(), err)
	}
}
